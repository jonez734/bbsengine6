# BBSEngine v6.0 Web Layer Specification
...
The web layer provides HTTP access to BBSEngine v6.0 functionality through Apache web server and PHP.
...
**Purpose:** Display information about BBSEngine v6.0
...
The web layer is **secondary** in BBSEngine v6.0. The primary application is the Python-based terminal interface. The web layer can optionally call Python backend for certain operations.
...
*Web Layer Specification for BBSEngine v6.0*
