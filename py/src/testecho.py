...
io.echo("{var:promptcolor}prompt color  {var:labelcolor}label color{f6}{inputcolor}input color{f6}{var:optioncolor}option color{/all}", end="")
io.echo(":smile:")
io.echo("{red}red fish, {blue}blue fish, {orange}orange fish{/all} {invalidcommandhere}")
