"""
Verify and initialize notifyd daemon schema.

Checks that the notifyd IMAP state and notification history tables exist
in the engine schema, and creates them if missing.
"""
