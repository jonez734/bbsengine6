...
drop table if exists engine.__notify_recipient;
...
create index idx_engine_notify_recipient_read on engine.__notify_recipient(dateread) where dateread is null;
