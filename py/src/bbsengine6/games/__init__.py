"""
bbsengine6/games/__init__.py
Game-type catalog and menu-derivation helpers for bbsengine6 clients.
...
Catalog origin: moved from ``casino.games.base`` so ``bbsengine6``
owns the game-type vocabulary. The legacy ``casino.games`` package
re-exports the same symbols for backwards compatibility.
"""
