...
def main(args, **kwargs):
    ...
    for r in ("term", "web", "sysop"):
        io.echo(f"{{var:labelcolor}}grant {{var:valuecolor}}connect{{var:labelcolor}} on {{var:valuecolor}}{args.databasename}{{var:labelcolor}} to {{var:valuecolor}}{r}{{var:labelcolor}}: ", end="")
        if database.manage_database_priv(args, "grant", "connect", args.databasename, r, **kwargs) is False:
            io.echo("fail", level="error")
            return False
        io.echo(" ok ", level="ok")
