...
class TestMessageLib:
    ...
    def test_store_message(self, mock_getpool):
    ...
    def test_get_pending_messages(self, mock_getpool):
        ...
        mock_cursor.fetchall.return_value = [
            (1, "casino:table:blackjack-1", "alice", "Hello", None, "ROUTINE", None, None, 
             "2024-01-01 12:00:00", "pending", None, None),
            (2, "member:bob", "charlie", "Hi there", None, "IMPORTANT", None, None,
             "2024-01-01 12:01:00", "delivered", "2024-01-01 12:02:00", None),
        ]
        mock_conn.cursor.return_value.__enter__.return_value = mock_cursor
        mock_pool = MagicMock()
        mock_pool.connection.return_value.__enter__.return_value = mock_conn
    ...
    @patch("bbsengine6.message.get_pending_messages")
...
class TestMessageTemplating:
    ...
    def test_render_template_mixed_syntax(self):
        ...
        result = render_template("{greeting} $name!", {"greeting": "Hi", "name": "Dave"})
